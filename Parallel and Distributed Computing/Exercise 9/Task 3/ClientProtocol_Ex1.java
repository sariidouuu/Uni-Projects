// Τα αρχεία ClientProtocol.java και ServerProtocol.java αντιπροσωπεύουν το Πρωτόκολλο της Εφαρμογής (Application Protocol). 
// Ουσιαστικά, αποτελούν τους «κανόνες» που διέπουν την επικοινωνία μεταξύ του πελάτη και του διακομιστή.
